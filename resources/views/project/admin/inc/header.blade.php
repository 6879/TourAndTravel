...
<!-- Mirrored from coderthemes.com/ubold/layouts/light/crm-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2019 15:37:40 GMT -->
<head>
        <meta charset="utf-8" />
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{URL::asset('frontendadmin/images/favicon.ico')}}">

        <!-- App css -->
        <link href="{{URL::asset('frontendadmin/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{URL::asset('frontendadmin/css/icons.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{URL::asset('frontendadmin/css/app.min.css')}}" rel="stylesheet" type="text/css" />
         <!-- Bootstrap Tables css -->
        <link href="{{URL::asset('frontendadmin/libs/bootstrap-table/bootstrap-table.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{URL::asset('frontendadmin/libs/ladda/ladda-themeless.min.css')}}" rel="stylesheet" type="text/css" />
         <link href="{{URL::asset('frontendadmin/libs/sweetalert2/sweetalert2.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="" role="button" aria-haspopup="true" aria-expanded="true">
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        ...
                        <div class="dropdown-menu">
                            <!-- item-->
                            <a href="oid(0);" class="dropdown-item">
