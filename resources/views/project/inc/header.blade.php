...
<!-- Mirrored from ecologytheme.com/theme/travelstar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Oct 2019 06:12:27 GMT -->
<head>
    <meta charset="UTF-8">
			...
			<div class="row">
				<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="contact_wrapper_top">
						...
						<div class="book-btn">
							<a href="{{ route('login') }}">Subscribe Now</a>
						</div>
					</div>
				</div>
			</div>
